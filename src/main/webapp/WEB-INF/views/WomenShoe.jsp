...
<body class="bg-success-subtle">
    <div class="container">
        ...
        <div class="card-columns mt-4">
            <div class="card">
                <a href="http://localhost:8088/women/shoes/sneakers">
            ...
            <div class="card">
                <a href="http://localhost:8088/women/shoes/loafers">
            ...
            <div class="card">
                <a href="http://localhost:8088/women/shoes/ballerinas">
                    <img src="https://m.media-amazon.com/images/I/61cT7BlFYcL._UY695_.jpg" alt="Trousers" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title">Ballerinas</h5>
                    </div>
                </a>
            </div>
            <div class="card">
                <a href="http://localhost:8088/women/shoes/boots">
            ...
            <div class="card">
                <a href="http://localhost:8088/women/shoes/sandals">
           ...
           <div class="card">
               <a href="http://localhost:8088/women/shoes/pumps">
                <img src="https://m.media-amazon.com/images/I/71lXdhdYScL._AC_UL600_FMwebp_QL65_.jpg" alt="Jeans" class="card-img-top">
                   <div class="card-body">
                    <h5 class="card-title">Pumps</h5>
                       ...
                       <div class="card">
                        <a href="http://localhost:8088/women/shoes/ankleBoots">
                          <img src="https://m.media-amazon.com/images/I/71lXdhdYScL._AC_UL600_FMwebp_QL65_.jpg" alt="Jeans" class="card-img-top">
                               <div class="card-body">
                              <h5 class="card-title">Ankle boots</h5>
                              </div>
                           </a>
                           </div>
        </div>
